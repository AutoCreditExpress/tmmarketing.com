$(function(){
    $('#setinterview').on('click', function(e){
        e.preventDefault();
        $('#setinterview').fadeOut(300);

        $.ajax({
            url: '../../inc/ajax/applicantStatus.php',
            type: 'post',
            data: {'action': 'follow', 'userid': '11239528343'},
            success: function(data, status) {
                if(data == "ok") {
                    $('#interviewConfirm').html('<p><em>Following!</em></p>');
 ...
 * Created by brianslaght on 4/23/14.
 */
